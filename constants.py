...
DATE_EXPERIMENT_START = datetime(2021, 1, 1)
...
DICT_Toyota_RAV = {
    ...
    'cost_tires'            : 17,  #TODO Покупка зимней резины 10 и 3 месяца
    'cost_tires_fitting'    : 7,  #TODO Шиномонтаж 10 и 3 месяца
    'cost_TO'               : 33,  # 170 два раза в год
