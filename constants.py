...
# К-во Клиентов по месяцам
COUNT_SELLS_BY_MONTHS_0 = \
    [ 1, 1 ]  # количество продаж по месяцам - mini

COUNT_SELLS_BY_MONTHS_1 = \
    [ 4,  1,  1,  1 ]  # количество продаж по месяцам - mini

COUNT_SELLS_BY_MONTHS_2 = \
    [ 1,  1,  1,  2,  2,  3 ]  # количество продаж по месяцам - 6 месяцев

COUNT_SELLS_BY_MONTHS_3 = \
    [ 1,  2,  4,  5,  6,  6,  5,  8,  9,  8]  # количество продаж по месяцам - 10 месяцев

COUNT_SELLS_BY_MONTHS_4 = \
    [ 1,  2,  4,  5,  6,  6,  5,  8,  9,  8,
     10, 10, 11, 12, 12, 13, 13, 15, 16, 16,
     17, 15, 18, 19, 18, 17, 18, 18, 19, 19,
     18, 18, 20, 20, 20, 22]  # количество продаж по месяцам - 36 месяцев

COUNT_SELLS_BY_MONTHS_5 = \
    [ 1,  2,  4,  5,  6,  6,  5,  8,  9,  8, 10, 10,
     10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10,
     10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10]  # количество продаж по месяцам - 36 месяцев

COUNT_SELLS_BY_MONTHS_6 = \
    [10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10]  # количество продаж по месяцам - 36 месяцев

COUNT_SELLS_BY_MONTHS_7 = \
    [ 1,  2,  4,  5,  6,  6,  5,  8,  9,  8,  10, 10,
      10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10,
      10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10,
      1,  2,  4,  5,  6,  6,  5,  8,  9,  8,  10, 10,
...
COST_REALTOR_PERCENT = 1.5  # Процент - Риелтор - Затраты в момент Покупки Квартиры
COST_NOTARY_PERCENT = 0.5  # Процент - Нотариус - Затраты в момент Покупки Квартиры
COST_TAX_PERCENT = 1.25  # Процент - Налоги Пенсионный фонд - Затраты в момент Покупки Квартиры
COST_BANK_FEE_PERCENT = 0.5  # Процент - Банковские комиссии - Затраты в момент Покупки Квартиры
