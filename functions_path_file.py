...
#
# def path_file_without_prefix(folder_name, file_name, experiment):  # генерирование название соответствующего файла
#     path_folder_ticker = path_folder(folder_name, experiment)
#
...
def path_folder(folder_name, experiment):  # создание папки, если еще не существует
    path_folder_ticker = folder_name  + '/' + experiment + '/'
